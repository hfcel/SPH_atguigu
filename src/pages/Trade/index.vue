  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        v-for="(addr, index) in addressInfo"
        :key="addr.id"
      >
        <span class="username" :class="{ selected: addr.isDefault == 1 }">{{
          addr.consignee
        }}</span>
        <p @click="changeDefault(addr, addressInfo)">
      ...
      <div class="detail">
        ...
        >
          <li>
            <img :src="order.imgUrl" alt="" style="width: 60px; height: 60px" />
          </li>
          <li>
            <p>
              {{ order.skuName }}
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        收货人：<span>{{ userDefaultAddress.consignee }}</span> 手机号：<span>{{
...
export default {
  ...
  methods: {
    changeDefault(addr, addressInfo) {
      // addressInfo.forEach(item=>item.isDefault=addr.id==item.id?1:0);
